...
var FunctionRegistry = []FuncMeta{
	...
	{Name: "fileRead", Args: "path", Desc: "read file contents as string", Category: "system"},
	{Name: "fileWrite", Args: "path, content", Desc: "write content to file (creates or overwrites)", Category: "system"},
	{Name: "fileAppend", Args: "path, content", Desc: "append content to file (creates if missing)", Category: "system"},
